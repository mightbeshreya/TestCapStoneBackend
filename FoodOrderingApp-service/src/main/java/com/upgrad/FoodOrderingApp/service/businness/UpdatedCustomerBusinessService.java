...
public class UpdatedCustomerBusinessService {
    ...
    public CustomerEntity customerToBeUpdated(String accessToken, String firstName, String lastName) throws AuthenticationFailedException, UpdateCustomerException {
